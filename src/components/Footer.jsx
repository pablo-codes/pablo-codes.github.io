    ...
    <footer className="bg-gradient-to-br from-gray-900 to-gray-800 text-white py-12">
      <div className="container-custom">
          ...
          <div>
            ...
            <div className="flex gap-3 mb-4">
              <a
                ...
                className="w-10 h-10 rounded-lg bg-gray-700 hover:bg-primary flex items-center justify-center transition-all transform hover:scale-110"
                aria-label="GitHub"
              >
                <svg
                  className="w-5 h-5"
            ...
            <p className="text-gray-400 text-sm">francisokpani570@gmail.com</p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © {currentYear} Francis Okpani. All rights reserved.
            </p>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          className="fixed bottom-8 right-8 w-12 h-12 bg-primary text-white rounded-full shadow-glow-strong flex items-center justify-center hover:bg-primary-600 transition-colors z-40"
