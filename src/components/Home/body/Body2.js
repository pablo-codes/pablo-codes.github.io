                                        ...
                                        <div className="col-sm-12 col-md-7 col-lg-7">
                                            <div className="home-text hp-left">
                                                <div className="owl-carousel text-rotation owl-loaded owl-drag">
                                                    ...
                                                    <p>
                                                        Hello, I'm Francis Okpani, a passionate MERN stack
                                                        web developer and smart contracts developer. With a
                                                        strong background in web development and a keen
                                                        interest in blockchain technology, I specialize in
                                                        creating dynamic and innovative digital solutions
                                                    </p>
                        ...
                        <div className="row">
                            <div className="col-xs-12 col-sm-12">
                                ...
                                <div className="block-title">
                                    <h2>What I Do</h2>
                                    <p>
                                        As a skilled MERN stack web developer and smart contracts
                                        developer, I offer a range of services to help businesses
                                ...
                                <div className="info-list-w-icon">
                                    <div className="info-block-w-icon">
                                        ...
                                        <div className="ci-text">
                                            ...
                                            <p>
                                                Build dynamic and responsive web applications using the
                                                MERN stack.
                                                Develop custom features and functionalities to meet your
                                                specific requirements.
                                                Ensure clean and efficient code that follows best
                                                practices and industry standards.
                                                Optimize websites for performance, scalability, and user
                                                experience.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="info-block-w-icon">
                                        ...
                                        <div className="ci-text">
                                            ...
                                            <p>
                                                ...
                                                Design cohesive and engaging user experiences that align
                                                with your brand identity.
                                                Develop wireframes and prototypes to bring your ideas to
                                                life.
                                                Implement modern design trends and best practices to
                                ...
                                <div className="info-list-w-icon">
                                    <div className="info-block-w-icon">
                                        ...
                                        <div className="ci-text">
                                            ...
                                            <p>
                                                Design and develop secure and efficient smart contracts
                                                on blockchain platforms.
                                                Utilize Solidity and other relevant languages to create
                                                custom contract solutions.
                                                Implement business logic and rules within smart
                                                contracts for decentralized applications.
                                                Conduct rigorous testing and security audits to ensure
                                    ...
                                    <div className="info-block-w-icon">
                                        ...
                                        <div className="ci-text">
                                            ...
                                            <p>
                                                Design and develop robust APIs to facilitate seamless
                                                data exchange between applications.
                                                Integrate third-party APIs and services to enhance
                                                functionality and expand capabilities.
                                                Implement authentication and authorization mechanisms to
                                ...
                                <div className="info-list-w-icon">
                                    <div className="info-block-w-icon">
                                        ...
                                        <div className="ci-text">
                                            ...
                                            <p>
                                                ...
                                                you can find me on the dance floor. I love expressing
                                                myself through dance and enjoy exploring various
                                                styles, from hip-hop to salsa.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="info-block-w-icon">
                                        ...
                                        <div className="ci-text">
                                            <h4>Melodic Voice</h4>
                                            <p>
                                                Singing is another passion of mine. I find joy in
                                                belting out tunes and exploring different genres.
                                                Whether it's performing in the shower or simply singing
                                                along to my favorite songs, music is an integral part of
                                                my life.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="info-list-w-icon">
                                    <div className="info-block-w-icon">
                                        ...
                                        <div className="ci-text">
                                            <h4>Movie Buff</h4>
                                            <p>
                                                I have a deep appreciation for the art of filmmaking.
                                                From classic masterpieces to the latest blockbusters, I
                                                love immersing myself in captivating storytelling and
                                                thought-provoking cinema. Ask me for movie
                                    ...
                                    <div className="info-block-w-icon">
                                        ...
                                        <div className="ci-text">
                                            ...
                                            <p>
                                                Troubleshooting code is like solving a puzzle for me. I
                                                thoroughly enjoy diving into complex problems and
                                                helping others debug their code. It's rewarding to
                                                unravel the mystery and find elegant solutions to
                                ...
                                <div className="fw-pricing clearfix row">
                                    ...
                                    <div className="fw-package-wrap col-md-4 default-col">
                                        <div className="fw-package">
                                            ...
                                            <div className="fw-button-row"></div>
                                            <div className="fw-default-row">Lorem ipsum dolor</div>
                                            <div className="fw-default-row">Pellentesque scelerisque</div>
                                            <div className="fw-default-row">Morbi eu sagittis</div>
                                            <div className="fw-default-row">Donec non diam</div>
